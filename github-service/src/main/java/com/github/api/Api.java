...
import com.github.model.MyPojo;
import com.github.service.JmsReceiver;
...
public class Api {
	...
	@RequestMapping(value="/scm/{user}/{repo}",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
	public List<MyPojo> findCommitInfo(@PathVariable("user") String user,@PathVariable("repo") String repo) {
        ...
        try {
			...
			jmsTemplate.convertAndSend("inbound.topic", "test message");
